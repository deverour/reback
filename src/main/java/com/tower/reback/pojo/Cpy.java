...
public class Cpy {
    ...
    public String getShifouzhigongdian() {
        return shifouzhigongdian;
    }

    public void setShifouzhigongdian(String shifouzhigongdian) {
    ...
    public String getJiesuanyunyingshang() {
        return jiesuanyunyingshang;
    }

    public void setJiesuanyunyingshang(String jiesuanyunyingshang) {
